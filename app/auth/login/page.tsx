        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="flex flex-col gap-2">
            <Button
              type="button"
              variant="outline"
              className="w-full flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white border-0"
            ...
            >
              ...
              {oauthLoading === 'google' ? 'Memuat...' : 'Google'}
            </Button>

            <Button
              type="button"
              variant="outline"
              className="w-full flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white border-0"
            ...
            >
              ...
              {oauthLoading === 'github' ? 'Memuat...' : 'GitHub'}
            </Button>

            <Button
              type="button"
              variant="outline"
              className="w-full flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white border-0"
            ...
            >
              ...
              {oauthLoading === 'discord' ? 'Memuat...' : 'Discord'}
            </Button>
          </div>
